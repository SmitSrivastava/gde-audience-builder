...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Featured Netflix Shows */}
      <div>
        <h2 className="text-2xl font-bold text-foreground mb-4">Featured Shows</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="relative rounded-xl overflow-hidden neon-border neon-border-hover card-hover group cursor-pointer" style={{ height: '220px' }}>
            <img src={mamlaLegalHai} alt="Maamla Legal Hai" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
            <div className="absolute bottom-0 left-0 p-5">
              <h3 className="text-lg font-bold text-white">Maamla Legal Hai</h3>
              <p className="text-xs text-white/70 mt-1">Season 2 • Comedy Drama</p>
            </div>
          </div>
          <div className="relative rounded-xl overflow-hidden neon-border neon-border-hover card-hover group cursor-pointer" style={{ height: '220px' }}>
            <img src={helloBachhon} alt="Hello Bachhon" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
            <div className="absolute bottom-0 left-0 p-5">
              <h3 className="text-lg font-bold text-white">Hello Bachhon</h3>
              <p className="text-xs text-white/70 mt-1">New Release • Drama</p>
            </div>
          </div>
        </div>
      </div>
